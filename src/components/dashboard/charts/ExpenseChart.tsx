...
const ExpenseChart = () => {
  ...
  const chartItems = monthlyExpenses.map((item, index) => {
    let color;
    switch (index % 6) {
      case 0: color = '#4F46E5'; break; // indigo-600
      case 1: color = '#0284C7'; break; // sky-600
      case 2: color = '#10B981'; break; // emerald-500
      case 3: color = '#F59E0B'; break; // amber-500
      case 4: color = '#EF4444'; break; // red-500
      default: color = '#8B5CF6'; break; // violet-500
    }
  ...
  return (
    <div className="bg-white rounded-xl shadow p-6">
      <h3 className="text-gray-800 font-medium text-lg mb-4">Monthly Expenses</h3>
      ...
      <div className="space-y-4">
        {chartItems.map((item, index) => (
          <div key={index} className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <span className="text-sm font-medium text-gray-800 mr-2">${item.amount}</span>
